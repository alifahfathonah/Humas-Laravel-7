                    ...
                    <div class="box">
                      <div class="box-header">
                        ...
                        <div class="pull-right">
                            <a href="{{url('admin/Berita/add')}}" class="btn btn-success">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$data->tanggal}}</td>
                                <td>
                                    <a href="{{ url('admin/Berita/edit/'.$data->id) }}" class="btn btn-warning btn-sm">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <form action="{{ url('admin/Berita/'.$data->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin Hapus Data')">
                                        @method('delete')
                                        @csrf
