 ...
 <section id="blog">
    ...
    <div class="blog container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="blog-item">
                    <a href="{{ url('Detail-Pengumuman/'.$Pengumuman->id) }}"><img class="img-responsive img-blog" src="{{ URL::to('assets') }}/images/post/{{ $Pengumuman->gambar }}" width="100%" alt="" /></a>
                    <div class="blog-content">
                        {{-- <a href="#" class="blog_cat">UI/UX DESIGN</a> --}}
                        <h2><a href="">{{$Pengumuman->judul}}</a></h2>
                        <p>{{date("d M Y", strtotime($Pengumuman->tanggal))}}</p>
                         {!!$Pengumuman->konten!!}
                    </div>
                </div>
                <!--/.blog-item-->
            ...
            <aside class="col-md-4">
              ...
              <div class="widget popular_post">
                  ...
                  <ul>
                      ...
                      <li>
                          <a href="{{ url('Detail-Pengumuman/'.$Data->id) }}">
